    ...
    return(
      ...
      <img src="/logo.svg" className="h-10" />
        ...
        <span className="px-2 drop-shadow-[0px_4px_16px_rgba(114,92,255,0.50)]">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 900 600"><path fill="#fff" d="M0 0h900v600H0z"/><path fill="#063" d="M0 0h450v600H0z"/><path fill="#d21034" d="M579.903811 225a150 150 0 1 0 0 150 120 120 0 1 1 0-150M585.676275 300 450 255.916106 533.852549 371.329239v-142.658277L450 344.083894z"/></svg>
          </div>
