...
const userTestimonials = [
  ...
  {
    avatar: <Avatar alt="Remy Sharp" src="https://mui.com/static/images/avatar/4.jpg" />,
    name: 'Julia Stewart',
    occupation: 'Senior Engineer',
    testimonial:
  ...
  {
    avatar: <Avatar alt="Travis Howard" src="https://mui.com/static/images/avatar/5.jpg" />,
    name: 'John Smith',
  ...
  {
    avatar: <Avatar alt="Cindy Baker" src="https://mui.com/static/images/avatar/6.jpg" />,
    name: 'Daniel Wolf',
    occupation: 'CDO',
    testimonial:
